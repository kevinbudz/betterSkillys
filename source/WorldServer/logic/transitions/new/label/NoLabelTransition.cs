...
{
    public sealed class NoLabelTransition : Transition
    {
        private readonly float _prob;
        private readonly LabelType _labelType;
        private readonly string _labelName;

        public NoLabelTransition(string labelName, LabelType labelType, params string[] targetState)
            : base(targetState)
        {
            _prob = 1.0f;
        ...
        public NoLabelTransition(float prob, string labelName, LabelType labelType, params string[] targetState)
            : base(targetState)
        {
            _prob = prob;
            _labelType = labelType;
