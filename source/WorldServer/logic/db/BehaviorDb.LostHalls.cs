            ...
            .Init("LH Marble Colossus",
                new State(
                    ...
                    new State("P-4",
                        ...
                        new Shoot(0, 16, 22.5, 4, -10, coolDownOffset: 1400, coolDown: 2400),
                        new TimedTransition(2000, "P-4-01")
                        ),
                    new State("P-4-01",
                        new ConditionEffectBehavior(ConditionEffectIndex.Armored, true),
                        new Shoot(0, 3, 30, 5, coolDownOffset: 2200, coolDown: 2800),
                        new Shoot(0, 16, 22.5, 4, -10, coolDownOffset: 1800, coolDown: 2400),
                    ...
                    new State("S-1",
                        ...
                        new State("P-8",
                            ...
                            new Shoot(0, 16, 22.5, 11, defaultAngle: 0, coolDownOffset: 1200, coolDown: 4000),
                        ...
                        new State("P-8-2",
                            ...
                            new Shoot(0, 4, projectileIndex: 6, coolDownOffset: 2000, coolDown: 1600),
                            new Shoot(0, 16, 22.5, 11, coolDownOffset: 1200, coolDown: 4000),
                    ...
                    new State("P-11",
                     ...
                     new State("S-3",
                        ...
                        new State("P-12",
                            ...
                            new Shoot(0, 16, 22.5, 20, 0, coolDownOffset: 1600, coolDown: 4800),
                            new Shoot(0, 16, 22.5, 20, 10, coolDownOffset: 2000, coolDown: 4800),
                            new Shoot(0, 16, 22.5, 20, 0, coolDownOffset: 2400, coolDown: 4800),
                            new Shoot(0, 3, 27, 13, predictive: 0.1, coolDownOffset: 2600, coolDown: 4800),
                            new Shoot(0, 3, 27, 13, predictive: 0.1, coolDownOffset: 3800, coolDown: 4800),
                            new Shoot(0, 3, 27, 13, predictive: 0.1, coolDownOffset: 4800, coolDown: 4800),
                    ...
                    new State("P-13",
                        new ConditionEffectBehavior(ConditionEffectIndex.Armored, true),
                        new Shoot(0, 4, projectileIndex: 6, coolDown: 5000),
                    ...
                    new State("P-18",
                        ...
                        new SetAltTexture(4),
                        new Duration(new Shoot(0, 16, 22.5, 20, rotateAngle: 18, defaultAngle: 0, coolDownOffset: 200, coolDown: 400), 3800),
                    ...
                    new State("P-20-C",
                        ...
                        new Shoot(0, 16, 22.5, 21, coolDown: 2000),
                        new HpLessTransition(0.60, "C-2"),
