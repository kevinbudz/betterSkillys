    ...
    partial class BehaviorDb
    {
        ...
        .Init("Dr Terrible",
            new State(
                ...
                new State("hide",
                    ...
                    new Order(100, "Red Gas Spawner LL", "OFF"),
                    new Order(100, "Red Gas Spawner LR", "OFF"),
                    new Order(10, "Dr Terrible Bubble", "spawning"),
                ...
                new State("nohide",
                    ...
                    new Order(100, "Red Gas Spawner LL", "ON"),
                    new Order(100, "Red Gas Spawner LR", "ON"),
                    new Order(10, "Dr Terrible Bubble", "idle"),
                    new Wander(0.5),
                    new SetAltTexture(0),
                    new TossObject("Green Potion", coolDown: 2000, coolDownOffset: 0),
        ...
        .Init("Dr Terrible Bubble",
            new State(
                ...
                new State("spawning",
                    new SetAltTexture(1),
                    new TimedTransition(500, "spawningTwo")
                    ),
                new State("spawningTwo",
                    new SetAltTexture(2),
                    new TimedTransition(500, "spawning")
                    )
                )
            )
